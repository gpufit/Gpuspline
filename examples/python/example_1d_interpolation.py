"""
An example for interpolating 1D data points calling a cubic spline
interpolation routine implemented in C.
...
if __name__ == '__main__':
    ...
    ax.plot(xq, yq, color='red', marker='x', label='interpolated')
    ax.grid()
    ax.set_xlim(0, 20)
